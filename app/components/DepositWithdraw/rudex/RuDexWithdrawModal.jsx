...
class RuDexWithdrawModal extends React.Component {
    ...
    _checkMinAmount() {
        ...
        const lessThanMinimum = withdraw_amount < (this.props.min_amount / utils.get_asset_precision(this.props.asset_precision));
        console.log("X", withdraw_amount, this.props.min_amount / utils.get_asset_precision(this.props.asset_precision));
    ...
    render() {
        ...
        if (this.state.options_is_valid) {
            options =
                <div className={!storedAddress.length ? "rudex-disabled-options" : "rudex-options"}>
        ...
        return (<form className="grid-block vertical full-width-content">
                <div className="grid-container">
                    ...
                    <div className="content-block">
                        ...
                        {this.state.minAmountError ? <p className="has-error no-margin" style={{paddingTop: 10}}><Translate content="gateway.rudex.min_amount_error" /></p>:null}
                        <p className="no-margin" style={{paddingTop: 10}}><b><Translate content="gateway.rudex.min_amount" minAmount={utils.format_number(this.props.min_amount / utils.get_asset_precision(this.props.asset_precision), this.props.asset_precision, false)} symbol={this.props.output_coin_symbol}/></b></p>
                    </div>
                    ...
                    <div className="button-group">
                        ...
                        <div onClick={this.onSubmit.bind(this)} className={"button" + (this.state.error || this.state.balanceError || this.state.minAmountError ? (" disabled") : "")}>
