...
import MarketRow0830 from "./MarketRow0830";
...
class MarketGroup extends React.Component {
    ...
    render() {
        ...
        let headers = columns.map(header => {
            switch (header.name) {
                case "market":
                    return <li key={header.name} style={ccc} onClick={this._changeSort.bind(this, "name")}><Translate content="exchange.market" /></li>;

                case "vol":
                    return <li key={header.name}  onClick={this._changeSort.bind(this, "volume")}style={ccc}><Translate content="exchange.vol_short" /></li>;

                case "price":
                    return <li key={header.name} style={ccc}><Translate content="exchange.price" /></li>;

                case "quoteSupply":
                    return <li key={header.name}><Translate content="exchange.quote_supply" /></li>;

                case "baseSupply":
                    return <li key={header.name}><Translate content="exchange.base_supply" /></li>;

                case "change":
                    return <li key={header.name}  onClick={this._changeSort.bind(this, "change")} style={ccc}><Translate content="exchange.change" /></li>;

                case "issuer":
                    return <li key={header.name}><Translate content="explorer.assets.issuer" /></li>;

                case "add":
                    return <li key={header.name} style={ccc}><Translate content="account.perm.confirm_add" /></li>;

                default:
                    return <li key={header.name} style={ccc}></li>;
            }
        });
...
class MyMarkets0830 extends React.Component {
        ...
        return (
            <div >
                ...
                <div
                    ...
                    ref="favorites"
                >
                    {assetsLoading ? <div style={{position: "absolute", paddingTop: "3rem", textAlign: "center", width: "100%"}}>
...
MyMarkets0830 = BindToChainState(MyMarkets0830);
