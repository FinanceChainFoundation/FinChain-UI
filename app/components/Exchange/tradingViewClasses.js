...
class SymbolInfo {
    constructor(options) {
        ...
        let {name: baseSymbol, prefix: basePrefix} = {name: options.baseAsset.get('symbol'), prefix: null}
        let {name: quoteSymbol, prefix: quotePrefix} = {name: options.quoteAsset.get('symbol'), prefix: null}
