...
import AccountSelector from "../Account/AccountSelector2";
...
class Transfer2 extends React.Component {
    ...
    constructor(props) {
        super(props);
        this.state = Transfer2.getInitialState();
        ...
        return (
            ...
            <div className="grid-block shrink vertical medium-horizontal" style={{paddingTop: "2rem"}}>
                ...
                <form style={{paddingBottom: 20, overflow: "visible"}} className="grid-content small-12 medium-6 large-5 large-offset-1 full-width-content" onSubmit={this.onSubmit.bind(this)} noValidate>
                        ...
                        {/*  F R O M  */}
                        <div className="content-block" style={{display:'none'}}>
                        ...
                        <div className="content-block transfer-input">
                            ...
                            <Translate className="left-label tooltip" component="label" content="transfer.header2" data-place="top" data-tip={counterpart.translate("tooltip.memo_tip")}/>
                        ...
                        <div className={"content-block transfer-input fee-row" + (this.state.propose ? " proposal" : "")
                            ...
                            {propose ?
                                ...
                                <button className={classnames("button float-right no-margin", {disabled: isSendNotValid})} type="submit" value="Submit" tabIndex={tabIndex++}>
                                    <Translate component="span" content="transfer.send2" />
                                </button>
                            }
                        </div>
                ...
                <div className="grid-content small-12 medium-6 large-5 right-column" style={{background:"#22292d"}}>
...
export default connect(Transfer2, {
    listenTo() {
        return [AccountStore];
    },
    getProps() {
